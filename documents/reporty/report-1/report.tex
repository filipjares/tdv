...
% V dalším textu jsou jednotlivé fáze popsány podrobněji.
...
\uv{slepování} takových dvojic kamer, tedy jejich umístění do společného souřadného systému. Řídký mrak
