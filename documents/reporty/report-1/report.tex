...
\section{Stereo, hustý mrak bodů}
	...
	scény. Pohled na takto získaný mrak bodů pocházející z~je\-dno\-ho páru kamer je na
	\figref{figStereoPair26}. Mraky dvojic bodů získané z jednotlivých dvojic obrazů stereo-párováním
	byly nakonec sloučeny do jediného hustého mraku bodů.
			...
			\begin{figure}[htbp]
				...
				\caption{\subref{figSourceAndDisparitySource} -- obraz \ref{figInputPictureB}; 
	...
	Pro rektifikaci párů obrazu -- výpočet rektifikačních homografií -- a pro určení disparit jsme
	použili opět kód dodaný vyučujícím. Konkrétně
