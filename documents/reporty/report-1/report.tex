...
\section{Řídký mrak bodů}
	...
	\subsection{Přilepování dalších kamer}
		...
		% ještě nemají 3D bod byly zrekonstruovány nové 3D body.
			...
			\begin{figure}[htb]
					\centering
						\includegraphics[width=9.3cm,clip=true,trim=165px 105px 110px 80px]{pictures/usporadani_kamer.pdf}
				\caption{Uspořádání kamer a řídký mrak bodů}
				\label{figCamerasAndSparseCloud}
			\end{figure}

		Pro správu korespondencí mezi obrazy a korespondencí mezi obrazy a mrakem 3D bodů byl využit
		opět kód dodaný vyučujícími \cite{code_repo}, \cite{gluing_correspondences}, 
		Pro manipulaci s korespondencemi mezi obrazy a OP
